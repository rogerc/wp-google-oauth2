...
Add Google OAuth2 login to site. It supports both regular google accounts and google apps. Google plus accounts should work too. Only persmissions it ask is email access and profile to populate name.

If using bc_oauth2, existing users will be able to log in without creating new users.
